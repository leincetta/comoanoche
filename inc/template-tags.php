...
function brosco_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav"></span> Viejos posts', 'brosco' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Nuevos posts <span class="meta-nav"></span>', 'brosco' ) ); ?></div>
			<?php endif; ?>
...
function brosco_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav"></span> Anterior', 'Previous post link', 'brosco' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( 'Siguiente <span class="meta-nav"></span>', 'Next post link',     'brosco' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
